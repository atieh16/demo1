					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<div class="card card-primary bg-primary-gradient">
								<div class="card-body">
									<h4 class="mb-1 fw-bold">لورم ایپسوم متن</h4>
						...
						<div class="col-md-4">
							<div class="card">
								<div class="card-body pb-0">
									...
									<h2 class="mb-2">17</h2>
									<p class="text-muted">کاربرهای آنلاین</p>
						...
						<div class="col-md-4">
							<div class="card">
								<div class="card-body pb-0">
									...
									<p class="text-muted">لورم ایپسوم متن</p>
									<div class="pull-in sparkline-fix">
					...
					<div class="row row-card-no-pd">
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<h4 class="card-title">لورم ایپسوم متن</h4>
										<div class="card-tools">
							...
							<div class="card">
								...
								<div class="card-body pb-0">
									...
									<div class="d-flex">
										...
										<div class="flex-1 pt-1 ml-2">
											<h6 class="fw-bold mb-1">لورم ایپسوم متن ساختگی</h6>
											<small class="text-muted">لورم ایپسوم متن ساختگی</small>
										</div>
										<div class="d-flex ml-auto align-items-center">
									...
									<div class="card-list">
										...
										<div class="item-list">
											...
											<div class="info-user ml-3">
												...
												<div class="status">مدیر عامل</div>
											</div>
											<button class="btn btn-icon btn-primary btn-round btn-xs">
												<i class="fa fa-plus"></i>
											</button>
						...
						<div class="col-md-4">
							<div class="card card-primary bg-primary-gradient">
								<div class="card-body">
									...
									<h4 class="mt-5 pb-3 mb-0 fw-bold">فعال ترین صفحات</h4>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">تولید سادگی نامفهوم </div>
										<div class="card-tools">
