						...
						<div class="page-inner py-5">
							<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
								<div>
									...
									<h5 class="text-white op-7 mb-2">کتابهای زیادی در شصت و سه درصد گذشته</h5>
								</div>
					...
					<div class="page-inner mt--5">
						...
						<div class="row">
								...
								<div class="card">
									<div class="card-header">
										<div class="card-head-row">
											<div class="card-title">جامعه و متخصصان </div>
							...
							<div class="col-md-4">
								<div class="card card-primary">
									<div class="card-header">
										<div class="card-title">فروش روزانه</div>
								...
								<div class="card card-primary bg-primary-gradient">
									<div class="card-body">
										<h4 class="mb-1 fw-bold"> راهکارها و شرایط سخت </h4>
						...
						<div class="row row-card-no-pd">
							<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										<div class="card-head-row">
											<h4 class="card-title">کاربران محلی</h4>
											<div class="card-tools">
						...
						<div class="row">
									...
									<div class="card-body pb-0">
										<div class="d-flex">
											...
											<div class="flex-1 pt-1 ml-2">
												...
												<small class="text-muted">شرایط فعلی تکنولوژی </small>
											</div>
										...
										<div class="d-flex">
											...
											<div class="flex-1 pt-1 ml-2">
												...
												<small class="text-muted">بهبود ابزارهای کاربردی</small>
											</div>
											<div class="d-flex ml-auto align-items-center">
										...
										<div class="d-flex">
											...
											<div class="flex-1 pt-1 ml-2">
												<h6 class="fw-bold mb-1">آماده ارائه</h6>
												<small class="text-muted">هدف بهبود ابزارهای کاربردی </small>
											</div>
											<div class="d-flex ml-auto align-items-center">
							...
							<div class="col-md-4">
								<div class="card">
									<div class="card-body">
										<div class="card-title fw-mediumbold">افراد پیشنهادی</div>
										<div class="card-list">
											<div class="item-list">
												<div class="avatar">
							...
							<div class="col-md-4">
								<div class="card card-primary bg-primary-gradient">
									<div class="card-body">
										<h4 class="mt-3 b-b1 pb-2 mb-4 fw-bold">جامعه و متخصصان</h4>
										<h1 class="mb-4 fw-bold">17</h1>
										<h4 class="mt-3 b-b1 pb-2 mb-5 fw-bold">جامعه و متخصصان</h4>
										<div id="activeUsersChart"></div>
										<h4 class="mt-5 pb-3 mb-0 fw-bold">جامعه و متخصصان</h4>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="card">
									<div class="card-header">
										<div class="card-title">چاپگرها و متون</div>
									</div>
									<div class="card-body">
										<ol class="activity-feed">
											<li class="feed-item feed-item-secondary">
												<time class="date" datetime="9-25">25 سپتامر</time>
												<span class="text">حروفچینی دستاوردها <a href="#">"فرهنگ پیشرو در زبان فارسی"</a></span>
											</li>
											<li class="feed-item feed-item-success">
												<time class="date" datetime="9-24">24 سپتامر</time>
												<span class="text">حروفچینی دستاوردها <a href="#">"فرهنگ پیشرو در زبان فارسی"</a></span>
											</li>
											<li class="feed-item feed-item-info">
												<time class="date" datetime="9-23">23 سپتامر</time>
												<span class="text">حروفچینی دستاوردها <a href="single-group.php">"فرهنگ پیشرو در زبان فارسی"</a></span>
											</li>
											<li class="feed-item feed-item-warning">
												<time class="date" datetime="9-21">21 سپتامر</time>
												<span class="text">حروفچینی دستاوردها <a href="#">"فرهنگ پیشرو در زبان فارسی"</a></span>
											</li>
											<li class="feed-item feed-item-danger">
												<time class="date" datetime="9-18">18 سپتامر</time>
												<span class="text">حروفچینی دستاوردها <a href="#">"فرهنگ پیشرو در زبان فارسی"</a></span>
											</li>
											<li class="feed-item">
												<time class="date" datetime="9-17">17 سپتامر</time>
												<span class="text">حروفچینی دستاوردها <a href="single-event.php">"فرهنگ پیشرو در زبان فارسی"</a></span>
											</li>
										</ol>
									</div>
								</div>
							...
							<div class="col-md-6">
								<div class="card">
									<div class="card-header">
										<div class="card-head-row">
											<div class="card-title">فرهنگ پیشرو در زبان فارسی</div>
											<div class="card-tools">
									...
									<div class="card-body">
										<div class="d-flex">
											...
											<div class="flex-1 ml-3 pt-1">
												...
												<span class="text-muted">طراحان رایانه ای علی الخصوص طراحان خلاقی</span>
											</div>
										...
										<div class="d-flex">
											...
											<div class="float-right pt-1">
												<small class="text-muted">2 روز قیل</small>
											</div>
										</div>
										<div class="separator-dashed"></div>
										<div class="d-flex">
